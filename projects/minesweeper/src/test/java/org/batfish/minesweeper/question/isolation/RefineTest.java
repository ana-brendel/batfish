...
public class RefineTest {
  ...
  // nf.configurationBuilder().setHostname(node.getName());
  //      configs.put(
  //          node,
  //          configBuilder
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkA(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  ...
  //        new RouteFilterList(PREFIX_MATCH, ImmutableList.of(new RouteFilterLine(PERMIT,
  // p_prefix)));
  //
  //    // Create configs
  ...
  //
  //    return null;
  //    // return new TestConfigConstructionUtils.Networkv2(tbdd, configs, templatePolicy,
  //    // List.of(p_str));
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkB(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //                getBgpActivePeerConfig("internalNeighbor", null, null),
  //                exit,
  //                getBgpActivePeerConfig("outside", "outsideImport", "outsideExport")));
  //
  //    // Creating routing policy
  //    RoutingPolicy templatePolicy =
  //        makePolicy(
  ...
  //        "outsideExport",
  //        ifStatement(
  //            checkForCommunity(plain_comm_10),
  //            permitRoute(false),
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkC(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //                NODE_A.getSingleIp(), getBgpActivePeerConfig("internalNeighbor", null, null),
  //                NODE_C.getSingleIp(),
  //                    getBgpActivePeerConfig("internalNeighbor", "rightImport", "rightExport")));
  //
  //    processes
  //        .get(NODE_C)
  //        .setNeighbors(
  ...
  //            ifStatement(
  //                checkForPrefixListMatch(PREFIX_MATCH),
  //                addToCommunities(plain_comm_10),
  //                permitRoute(true)));
  //
  //    makePolicy(
  //        configs.get(NODE_B),
  //        "rightImport",
  //        ifStatement(
  //            checkForCommunity(plain_comm_20), addToCommunities(plain_comm_10),
  // permitRoute(true)));
  //    makePolicy(
  //        configs.get(NODE_B),
  //        "rightExport",
  //        ifStatement(
  //            checkForCommunity(plain_comm_10), addToCommunities(plain_comm_20),
  // permitRoute(true)));
  //
  //    makePolicy(
  //        configs.get(NODE_C),
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkD(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //        "rightImport",
  //        ifStatement(
  //            checkForCommunity(plain_comm_20),
  //            replaceCommunities(plain_comm_10),
  //            permitRoute(true)));
  //    makePolicy(
  //        configs.get(NODE_B),
  ...
  //        ifStatement(
  //            checkForCommunity(plain_comm_10),
  //            replaceCommunities(plain_comm_20),
  //            permitRoute(true)));
  //
  //    // makePolicy(configs.get(NODE_C),"outsideImport",clearCommunities());
  //    makePolicy(
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkE(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //            checkForPrefixListMatch(PREFIX_MATCH),
  //            permitRoute(false),
  //            addToCommunities(plain_comm_20)));
  //
  //    // Set up the tbdd
  //    Set<RegexConstraint> communityRegexes =
  //        ImmutableSet.<RegexConstraint>builder()
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkF(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //            ImmutableSortedMap.of(
  //                NODE_A.getSingleIp(),
  //                    getBgpActivePeerConfig("internalNeighbor", "neighborImport", null),
  //                NODE_C.getSingleIp(),
  //                    getBgpActivePeerConfig("internalNeighbor", "neighborImport", null)));
  //
  //    processes
  ...
  //            .add(RegexConstraint.parse(plain_comm_10))
  //            .add(RegexConstraint.parse(plain_comm_20))
  //            .add(RegexConstraint.parse(plain_comm_30))
  //            .build();
  //    ConfigAtomicPredicates configAPs =
  //        getConfigAtomicPredicates(configs.values(), communityRegexes);
  //    TransferBDD tbdd = new TransferBDD(configAPs);
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkG(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //            permitRoute(false),
  //            ifStatement(
  //                checkForPrefixListMatch(PREFIX_MATCH), permitRoute(false), permitRoute(true))));
  //
  //    // Set up the tbdd
  //    Set<RegexConstraint> communityRegexes =
  //
  ...
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkH(
  //      Ip entry,
  //      Ip exit,
  //      Node NODE_A,
  //      Node NODE_B,
  ...
  //    PrefixRange p_prefix = PrefixRange.fromPrefix(Prefix.parse(p_str));
  //    RouteFilterList pPrefixMatch =
  //        new RouteFilterList(
  //            PREFIX_MATCH_P, ImmutableList.of(new RouteFilterLine(PERMIT, p_prefix)));
  //
  //    String PREFIX_MATCH_Q = "prefixMatch";
  //    PrefixRange q_prefix = PrefixRange.fromPrefix(Prefix.parse(q_str));
  //    RouteFilterList qPrefixMatch =
  //        new RouteFilterList(
  //            PREFIX_MATCH_Q, ImmutableList.of(new RouteFilterLine(PERMIT, q_prefix)));
  //
  //    // Create configs
  //    setUpConfigs(configs, NODE_A, NODE_B, NODE_C);
  //
  ...
  //                    "internalNeighbor", preventBackwards ? "rightImport" : null, null)));
  //
  //    processes
  //        .get(NODE_B)
  //        .setNeighbors(
  //            ImmutableSortedMap.of(
  //                NODE_A.getSingleIp(),
  //                    getBgpActivePeerConfig("internalNeighbor", "leftImport", null),
  //                NODE_C.getSingleIp(),
  //                    getBgpActivePeerConfig(
  //                        "internalNeighbor", preventBackwards ? "rightImport" : null, null)));
  //
  ...
  //            "outsideImport",
  //            ifStatement(
  //                checkForPrefixListMatch(PREFIX_MATCH_P),
  //                replaceCommunities(plain_comm_10),
  //                replaceCommunities(plain_comm_30)));
  //
  //    makePolicy(
  //        configs.get(NODE_B),
  //        "leftImport",
  //        ifStatement(
  //            checkForPrefixListMatch(PREFIX_MATCH_Q),
  //            replaceCommunities(plain_comm_20),
  //            permitRoute(true)));
  //    if (preventBackwards) {
  ...
  //            checkForCommunity(plain_comm_10),
  //            permitRoute(true),
  //            ifStatement(checkForCommunity(plain_comm_20), permitRoute(true),
  // permitRoute(false))));
  //
  //    // Set up the tbdd
  //    Set<RegexConstraint> communityRegexes =
  ...
  //    //        tbdd, configs, templatePolicy, List.of(p_str, q_str));
  //    return null;
  //  }
  //
  //  private TestConfigConstructionUtils.Networkv2 networkI(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str, String q_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  //    String regex_comm_10_10 = "^" + plain_comm_10 + "$";
  ...
  //        networkA(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  ...
  //        new Invariant(
  //            net.tbdd(),
  //            Invariant.clauseBuilder().avoidPrefix(PREFIX).build(net.tbdd(), net.template()));
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkB(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkC(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkD(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkE(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkF(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkG(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkH(entry, exit, NODE_A, NODE_B, NODE_C, p_str, q_str, true);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  //    Invariant.ClauseBuilder PREFIX_P =
  //        Invariant.clauseBuilder()
  //            .matchPrefix(new PrefixSpace(PrefixRange.fromPrefix(Prefix.parse(p_str))));
  //    Invariant.ClauseBuilder PREFIX_Q =
  //        Invariant.clauseBuilder()
  //            .matchPrefix(new PrefixSpace(PrefixRange.fromPrefix(Prefix.parse(q_str))));
  //    Invariant property =
  //        Invariant.builder()
  //            .addClause(PREFIX_P)
  //            .addClause(PREFIX_Q)
  ...
  //    String q_str = "13.25.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        networkI(entry, exit, NODE_A, NODE_B, NODE_C, p_str, q_str);
  //    NetworkInfo info = net.getInfo();
  //    Infer verifier = info.toInfer();
  //    Lightyear lightyear = info.checker();
  //
  ...
  // The "refineNetwork*()" tests explicit check for what the expected refinements are, these might
  // change if we change refinement
  //  private TestConfigConstructionUtils.Networkv2 refineNetwork1(
  //      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
  //    Map<Node, Configuration> configs = new HashMap<>();
  //
  //    String plain_comm_10 = "10:10";
  ...
  //            ImmutableSortedMap.of(
  //                NODE_A.getSingleIp(), getBgpActivePeerConfig("internalNeighbor", null, null),
  //                NODE_C.getSingleIp(), getBgpActivePeerConfig("internalNeighbor", null,
  // null)));
  //
  //    processes
  //        .get(NODE_C)
  ...
  //                    permitRoute(false),
  //                    ifStatement(
  //                        checkForCommunity(plain_comm_30), permitRoute(false),
  // permitRoute(true)))));
  //
  //    // Set up the tbdd
  //    Set<RegexConstraint> communityRegexes =
  ...
  //    String p_str = "25.13.0.0/16";
  //    TestConfigConstructionUtils.Networkv2 net =
  //        refineNetwork1(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
  //    NetworkInfo info = net.getInfo();
  //
  //    PrefixSpace PREFIX = new PrefixSpace(PrefixRange.fromPrefix(Prefix.parse(p_str)));
  //    Invariant property =
  ...
  //
  //    Invariant refined_property =
  //        Invariant.builder()
  //            .addClause(Invariant.clauseBuilder().avoidPrefix(PREFIX))
  //            .addClause(
  //                Invariant.clauseBuilder()
  //                    .setCommunities(new
  // RegexConstraints(List.of(RegexConstraint.parse("10:10")))))
  //            .build(net.tbdd(), net.template());
...
//  private TestConfigConstructionUtils.Networkv2 refineNetwork2(
//      Ip entry, Ip exit, Node NODE_A, Node NODE_B, Node NODE_C, String p_str) {
    //    Map<Node, Configuration> configs = new HashMap<>();
    //
    //    String plain_comm_10 = "10:10";
    ...
    //        .setNeighbors(
    //            ImmutableSortedMap.of(
    //                NODE_A.getSingleIp(), getBgpActivePeerConfig("internalNeighbor", null,
    // "outToA"),
    //                NODE_C.getSingleIp(), getBgpActivePeerConfig("internalNeighbor", null,
    // "outToC")));
    //
...
//  public void refineNetwork2Test() {
    ...
    //    String p_str = "25.13.0.0/16";
    //    TestConfigConstructionUtils.Networkv2 net =
    //        refineNetwork2(entry, exit, NODE_A, NODE_B, NODE_C, p_str);
    //    NetworkInfo info = net.getInfo();
    //
    //    PrefixSpace PREFIX = new PrefixSpace(PrefixRange.fromPrefix(Prefix.parse(p_str)));
    //    Invariant property =
    ...
    //                Invariant.clauseBuilder()
    //                    .setCommunities(new
    // RegexConstraints(List.of(RegexConstraint.parse("20:20")))))
    //            .build(net.tbdd(), net.template());
    //    Invariant prefix_or_1010_or_2020 =
    //        Invariant.builder()
    //            .addClause(Invariant.clauseBuilder().avoidPrefix(PREFIX))
    //            .addClause(
    //                Invariant.clauseBuilder()
