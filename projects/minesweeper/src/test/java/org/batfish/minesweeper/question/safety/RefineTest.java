...
public class RefineTest {
  ...
  private TestConfigConstructionUtils.Networkv2 networkC(
    ...
    makePolicy(
        ...
        "rightImport",
        ifStatement(
            checkForCommunity(plain_comm_20), addToCommunities(plain_comm_10), permitRoute(true)));
    makePolicy(
        configs.get(NODE_B),
        "rightExport",
        ifStatement(
            checkForCommunity(plain_comm_10), addToCommunities(plain_comm_20), permitRoute(true)));
        ...
        makePolicy(
            ...
            ifStatement(
                ...
                ifStatement(
                    ...
                    permitRoute(false),
                    ifStatement(
                        checkForCommunity(plain_comm_30), permitRoute(false), permitRoute(true)))));
