...
public class LightyearTest {
  ...
  public void originalExampleTest() {
    ...
    Optional<Map.Entry<Location, Location>> l1 =
        net.getInfo()
            .checker()
            .check(
                Map.of(
                    ALPHANODE,
                    new Invariant(net.tbdd()),
                    BETANODE,
                    notPrefix_or_100_1_or_100_2.copy(),
                    GAMMANODE,
                    notPrefix_or_100_2.copy(),
                    DELTANODE,
                    notPrefix.copy(),
                    new Edge(ALPHANODE, BETANODE),
                    notPrefix_or_100_1_or_100_2.copy(),
                    new Edge(BETANODE, ALPHANODE),
                    new Invariant(net.tbdd()),
                    new Edge(BETANODE, GAMMANODE),
                    notPrefix_or_100_2.copy(),
                    new Edge(GAMMANODE, BETANODE),
                    notPrefix_or_100_1_or_100_2.copy(),
                    new Edge(GAMMANODE, DELTANODE),
                    notPrefix.copy(),
                    new Edge(DELTANODE, GAMMANODE),
                    notPrefix_or_100_2.copy()));
