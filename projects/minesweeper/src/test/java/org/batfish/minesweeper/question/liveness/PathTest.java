...
public class PathTest {
  //  private Path.Context empty_context;

  @Before
  public void setup() throws IOException {
    //    TransferBDD tbdd = new TransferBDD(new ConfigAtomicPredicates(List.of(), Set.of(),
    // Set.of()));
    //    empty_context =
    //        new Path.Context(
    //            tbdd,
  ...
  public void pathBuilderTests() {
    ...
    //    Node c =
    //        new Node(Set.of(Ip.parse("10.0.0.3"), Ip.parse("11.0.0.3"), Ip.parse("12.0.0.3")),
    // "nodeC");
