...
public class Lightyear {
    ...
    public Lightyear(Map<Ip, Node> nodes, Map<Edge, RoutingPolicy> imports, Map<Edge, RoutingPolicy> exports) {
        this.nodes = nodes;
    ...
    private boolean completeCheck(Invariant pre, Invariant post, RoutingPolicy policy) {
        ...
        Invariant weakestConditionForNegation = policy == null ? negatedPost.copy() :
                negatedPost.weakestPrecondition(policy,false);
